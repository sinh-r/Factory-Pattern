...
namespace StorageServiceApp.Api.Models.ObjectOperationResponse
{
        ...
        ObjectResponse(objectName, containerName, "UPLOAD", isSuccess, error)
    {
        ...
        public static UploadObjectResponse ExceptionOccuredFailure(string objectName, string containerName, string message) => new(objectName, containerName, false, $"Excpetion occure while uploading {objectName}. Exception Message: {message}");
    }
}
